This is the frontend of the Fastage website a responsive React application built with Tailwind CSS and Lucide React icons and also use PWA method for creating this web into app
